...
let AnimalData = [
    ...
    +"<p>どうぶつの近くに行って地図の黄色い丸をタップすると、" + "<br>" + "どうぶつの紹介が読めるようになるよ！<\p>" + "<br>"+"<br>"+"<br>"+"<br>",
    ...
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" +"<p>主に単独で行動し、眼下線を擦り付ける臭い付けによりなわばりを主張する。" + "<br>" 
    ...
    +"地球と一体化した省エネ動物と言えるかも知れない。<\p>"+"<br>"+"<br>"+"<br>"+"<br>",
    ...
    +"しかし、急速な人口増加や、それによる土地開拓などによる森林の伐採、また食用や象牙のための密猟などで、生息数や生息地の減少が、現在も問題視されている。<\p>"+"<br>"+"<br>"+"<br>"+"<br>",
    ...
    //フラミンゴ
    "<h2>フラミンゴ<\h2>"
    +"<h3>フラミンゴ目フラミンゴ科"+"<br>"+"(生息地)アフリカ、南ヨーロッパ、中南米の塩湖や干潟<\h3>"+"<br>"+"<br>"+"<br>"+"<br>",
