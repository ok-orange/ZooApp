let AnimalData = [
  ...
  +"<div style='text-align: center'><img src='./pic/lesserpanda1.JPG' width='90%'></div>"
    ...
    +"地上を歩くときは人間やクマのように足の裏全体をつけて歩く。"+"<br>"
    +"食性は雑食性で、笹が主ではあるが、鳥類の卵や小型哺乳類を食べることもある。"+"<br>"+"<br>"
  ...
  "<div style='text-align: center'><img src='./pic/tsukinowaguma0.JPG' width='90%'></div>"
    ...
    +"<p>日本のツキノワグマのことを紹介しているよ。" + "<br>" + "かわいいLINEスタンプで募金もできるよ！</p>" + "<br>"+"<br>"
    
    +"<h2><p>なまえ：よねこ</p></h2>" +"<br>"
    +"<h3>食肉目(ネコ目)クマ科" +"<br>" 
  ...
  "<div style='text-align: center'><img src='./pic/flamingo1.JPG' width='90%'></div>"
    +"<h2>ヨーロッパフラミンゴ</h2>"
    +"<h3>フラミンゴ目フラミンゴ科"+"<br>"
    +"<p>(生息地)アフリカ、インド西北部、地中海沿岸など</p></h3>"+"<br>"
    +"<h3>～どんなどうぶつ？～</h3>" + "\n" 
    +"<p>世界中の熱帯と温帯域の水辺に広く住んでいる。"+"<br>"
    +"3月～4月になると羽の色が一層鮮やかになりツガイ(夫婦)をつくる前のディスプレイ(ダンス)をはじめる。"+"<br>"
    +"5月～7月に干潟や海岸に高さ30cmくらいの泥の巣をつくり産卵する。"+"<br>"
    +"ふ化したヒナに、フラミンゴミルクと呼ばれる真っ赤な分泌液を口移しに与える。"+"<br>"
    +"くちばしは泥の中の水中のプランクトンをこしとって食べるために独特の形をしている。</p>"
    +"<br>"
    +"<br>"
    +"<br>"
    +"<h2>チリ―フラミンゴ</h2>"
    ...
    +"<p>(生息地)南アメリカ</p></h3>"+"<br>"
    +"<h3>～どんなどうぶつ？～</h3>" + "\n" 
    +"<p>山地の塩水湖などや、海抜4500m以上のアンデス山中の高地にも生息している。"+"<br>"
    +"羽色は淡いピンク色で、脚の真ん中の関節および脚先が赤い色をしている。"+"<br>"
    +"脚は鉛がかった黄色をしている。"+"<br>"
    +"小魚や小エビ、植物性・甲殻類プランクトンを食べる。"+"<br>"
    +"繁殖期は3月～7月で、1個(まれに2個)の卵を産む。"+"<br>"
    +"野生での寿命は平均40年。</p>"
    +"<br>"+"<br>"+"<br>"+"<br>",
  ...
  "<div style='text-align: center'><img src='./pic/ookami1.JPG' width='90%'></div>"
    +"<h3>みえないときは寝室か矢印の方向にいることがあるよ！"+"<br>"
    +"遠吠えを聞くことができたらラッキーかも？</h3>" + "<br>"
    +"<h2><P>なまえ：ユウキ (2011年うまれ)</p></h2>" +"<br>"
    +"<h3>食肉目(ネコ目)イヌ科" +"<br>" 
  ...
  "<div style='text-align: center'><img src='./pic/pololo4.JPG' width='90%'></div>"
    ...
    +"<h2><p>なまえ：ポロロ (メス、2012年うまれ)"+"<br>"
        +"イワン (オス、2000年うまれ)</p></h2>" +"<br>"
    +"<h3>食肉目(ネコ目)クマ科" +"<br>" 
