...
let AnimalData = [
    ...
    //フライングゲージ
    "<h2>今はフライングゲージには入れないけど、外の壁に鳥たちの紹介があるよ！"+"<br>"+"見てみてね。<\h2>"
    ...
    //ニホンカモシカ
    "<h2>名前：ハツヤ<\h2>" + "<br>"
    +"<h3>偶蹄目ウシ科" +"<br>" +"(生息地)"+"<br>"+"日本の本州・四国・九州のブナやミズナラを中心とした落葉広葉樹林<\h3>" + "<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" +"<p>主に単独で行動し、眼下線を擦り付ける臭い付けによりなわばりを主張する。" + "<br>" + "食性は草食性で、木の葉や芽、樹皮、果実などを食す。<\p>"+"<br>",
    ...
    +"ジャイアントパンダほどではないが、手首に特殊な突起があり、この突起と他の指を使って主食の細い竹の枝などをつかんで食べることができる。"+"<br>"
    + "カギ爪や長い尾をたくみに使い木に登り、樹上を移動する。地上を歩くときは人間やクマのように足の裏全体をつけて歩く。"+"<br>"
    ...
    +"<h2>名前：マービー<\h2>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>日本では北海道・本州・四国・九州に住んでいて、北海道にいるものをエゾタヌキという。夜行性で、人の影響の少ない場所では日中も活動する。"+"<br>"
    +"イヌ科の仲間では例外的に木登りが上手で、決まった場所にフンをし、これをタヌキの「ためフン」という。フンは巣穴の外でするため、巣穴はいつも清潔である。"+"<br>"
    ...
    +"コツメカワウソは前あしの一部にしか水掻きがなく、ずんぐりとした指をしており、爪は痕跡程度の小さなものである。"+"<br>"
    ...
    +"<br>"
    +"※「カワウソの秘密～器用な手や口について～」も見てみてね！<\p>"+"<br>",
    ...
    +"<h3>食肉目(ネコ目)クマ科" +"<br>" +"(生息地)"+"<br>"+"ユーラシア大陸東部から東アジアにかけて<\h3>" + "<br>"
    +"<h2>名前：よねこ<\h2>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n"
    +"<p>ツキノワグマは森林に生息し、単独で夜行性が強いが日中も活動する。"+"<br>"
    +"植物食傾向の強い雑食で、季節に応じて様々なものを食べている。"+"<br>"
    +"12~4月ごろに冬眠し、メスは冬眠中に1,2頭の子を産む。" + "<br>"
    +"ツキノワグマは７つの亜種に分類される。日本に分布するのは亜種ニホンツキノワグマで、本州・四国・九州に分布する。(九州では絶滅した可能性が高いと考えられている。)" + "<br>"
    +"この種は亜種の中でも小型で、黒い体毛で覆われ、胸部に三日月型の白斑をもつ(ない個体もいる)。"+"<br>" + "体長120~180cm、体重50~150kg。" + "<br>" + "<\p>"+"<br>",


    //モンキープロムナード
    "<h2>シシオザル<\h2>"
    +"<h3>霊長目オナガザル科　(生息地)インド南西部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>顔の周りの灰色の長い毛以外は全身真っ黒の毛でおおわれ、しっぽの先端がライオンのように房状になっている。"+"<br>"
    +"熱帯林に10~20頭の群れでくらし、1日の活動時間のうち採食に54%、休けいに27%、移動に15%、その他に4%費やす。"+"<br>"
    ...
    +"<br>"
    +"<h2>ブタオザル<\h2>"
    +"<h3>霊長目オナガザル科　(生息地)東南アジア<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>ニホンザルと似た群れ社会をつくって生活しており、メスは基本的に生まれた群れにとどまるが、オスは若ものになると生まれた群れから出ていく。"+"<br>"
    +"群れの大きさは、20～30頭、多いもので80頭程度で、海岸から内陸林、低地から高地の森林に広く分布しています。"+"<br>"
    +"移動のときは地上を使うが、木登りは得意である。<\p>"
    +"<br>"
    +"<br>"
    +"<br>"
    +"<h2>ニホンザル<\h2>"
    +"<h3>霊長目オナガザル科"+"<br>"+"(生息地)日本<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    ...
    +"<br>"
    +"<h2>チンパンジー<\h2>"
    +"<h3>霊長目オランウータン科"+"<br>"+"(生息地)アフリカ中部・西部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>チンパンジーは離合集散をくりかえし、15頭～100頭の群れで生活している。"+"<br>"
    +"ニホンザルの群れとちがってメスは性成熟すると別の群れに移り、オスが群れに残ることが多い。"+"<br>"
    ...
    +"<br>"
    +"<h2>ワオキツネザル<\h2>"
    +"<h3>霊長目キツネザル科"+"<br>"+"(生息地)マダガスカル南部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>乾燥した森や川辺の林に生息しており、木や枝の間をジャンプして飛び回ったり、地上を長い尾を立てて歩いて移動したりする。"+"<br>"
    +"樹上で眠り、早朝には太陽に体を向けて日光浴する。気温の高い昼間は木陰で寝る。"+"<br>"
    ...
    +"<br>"
    +"<h2>マントヒヒ<\h2>"
    +"<h3>霊長目オナガザル科"+"<br>"+"(生息地)アフリカ東部・アラビア半島西南部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>日中は海岸部の低木がまばらに生えている荒れ地や半砂漠地帯・草原ですごし、夜は険しい崖や垂直な岩場にのぼり、外敵から身を守りながら眠る。"+"<br>"
    +"群れは一夫多妻のグループが集まって構成されている。"+"<br>"
    +"最小の社会単位はワンメイル・ユニットと呼ばれ、これが2~3集まった集団をクランと呼ぶ。クランと単独のオスが集合すると、バンドと呼ぶ大集団となる。"+"<br>"
    +"おとなのオスにだけ立派なマントがある。<\p>"+"<br>",
    ...
    +"<br>"
    +"<h2>ニシアフリカコガタワニ<\h2>"
    +"<h3>ワニ目クロコダイル科"+"<br>"+"(生息地)サハラ砂漠以南のアフリカ大陸西部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>全長約2mで、サハラ砂漠以南のアフリカ大陸西部に分布し、海水内で発見されることもある。"+"<br>"
    +"頭部は吻(ふん)が短く、後端が切れ上がりクルミ割り状の形態をしており、貝類や甲殻類を捕食するために特殊化した結果と考えられる。"+"<br>"
    +"子供には黄色い横縞(よこじま)があるが、大人になるとこの縞は消え、黒っぽい体になる。"+"<br>"
    +"6～8月に塚を作って約20個産卵し、卵は約100日でふ化する。"+"<br>"
    +"クロコダイル科では比較的原始的な形態を持ち、陸棲(りくせい)傾向が強いため、クロコダイル科の祖先の性質を残すものと考えられる。<\p>"
    +"<h3>※「クロコダイルとアリゲーター」も見てみてね！<\h3>"+"<br>"
    +"<br>"
    +"<br>"
    +"<br>"
    +"<h2>メガネカイマン<\h2>"
    +"<h3>ワニ目アリゲーター科"+"<br>"+"(生息地)中央アメリカ、南アメリカの北部・中部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>ワニ類は、他のどんな爬虫類よりも進化した構造の脳と心臓を持っており、体は固いヨロイの様なウロコに包まれ非常に頑丈である。"+"<br>"
    +"カイマンを含むアリゲーター化のワニは口先が丸みがかっており、クロコダイル科のワニは細くとがっている。"+"<br>"
    ...
    +"<br>"
    +"<h2>ケヅメリクガメ<\h2>"
    +"<h3>カメ目リクガメ科"+"<br>"+"(生息地)アフリカ東部・中部・西部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>最大甲長72cmで、背甲は褐色で模様はなく、臀部(でんぶ)の大きなうろこが蹴爪(けづめ)状に発達する。"+"<br>"
    ...
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>ヤマネコ類では最大級の大きさを誇り、体の大きさの割に敏捷(びんしょう)で瞬発力に優れ、高さ4m、幅12mほどの跳躍記録を持っている。"+"<br>"
    ...
    +"<br>"
    +"<h2>フタユビナマケモノ<\h2>"
    +"<h3>ナマケモノ亜目フタユビナマケモノ科<\h3>" +"<br>"
    +"<h2>名前：ビリー　(南米ガイアナうまれ)<\h2>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>そのゆったりした動作から「ナマケモノ」という呼び名のついた動物で、食事から睡眠、出産にいたるまで樹にぶら下がったまま行う。"+"<br>"
    +"活動は主に夜間で、1日の2/3以上を寝て過ごすため体が苔むす事もある。"+"<br>"
    +"地球と一体化した省エネ動物と言えるかも知れない。<\p>",


    //セイロンゾウ
    "<h3>" +"<br>" +"(生息地)スリランカ<\h3>"
    +"<h2>名前：マリー (1990年うまれ)<\h2>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n"
    +"<p>現在アジアゾウは、インドゾウ・ボルネオゾウ・スマトラゾウ・そしてセイロンゾウの4種が確認されている。"+"<br>"
    ...
    +"群れで生活し、日中は主に家族やペアで巣を出て、日暮れになると巣へ戻る。" + "<br>"
    +"雑食性で、小さな哺乳類や爬虫類、昆虫、クモ、植物の根や果物などを食べる。" + "<br>"
    ...
    +"<h2>名前：レオ(2010年生まれ、オス)"+"<br>"
       +"　　　ムーン(2018年うまれ、メス)<\h2>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n"
    +"<p>猫の仲間は単独生活する種類が多いが、ライオンは群れをつくって暮らしている。"+"<br>"
    +"群れのメンバーは、1頭~3頭のオスと15頭くらいまでのメスと子どもたちで、群れの構成が一般のファミリーと違うことからプライドと呼び区別している。" + "<br>"
    +"1日に20時間は休息するライオンは、日没ごろ狩りに出ていき、多くはメスが獲物を捕らえる。狩りの成功率は4回に1回くらいである。" + "<br>"
    ...
    +"<h2>カピバラ<\h2>"
    +"<h3>齧歯目(げっしもく)テンジクネズミ科"+"<br>" +"(生息地)南アメリカ東部<\h3>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n" 
    +"<p>オスには「モリージョ」という、においを出すコブがある。"+"<br>"
    +"野生のカピバラは一夫多妻制の群れ生活をおくり、水辺のイネ科の植物を食べるが、とくしま動物園では野菜や果物などを食べている。"+"<br>"
    +"用途によって鳴き声が変わる。(カピバラの紹介ボードに詳しく書いてあるよ！)"+"<br>"
    +"生まれてすぐの赤ちゃんでも泳げるくらい泳ぎが上手で、足の肉球はハート型になっておりチャームポイント。"+"<br>"
    +"前歯は上下2本ずつで奥歯もある。一生伸び続けるため、木の茎や石ころを噛んで削ったり折ったりする。<\p>"
    +"<br>"
    +"<br>"
    +"<br>"
    +"<h2>チャップマンシマウマ<\h2>"
    ...
    //フラミンゴ
    "<h2>フラミンゴ<\h2>"
    +"<h3>フラミンゴ目フラミンゴ科"+"(生息地)アフリカ、南ヨーロッパ、中南米の塩湖や干潟<\h3>"+"<\p>",


    //オオカミ
    "<h2>みえないときは寝室か矢印の方向にいることがあるよ！<\h2>" + "<br>"
    +"<h3>食肉目(ネコ目)イヌ科" +"<br>" +"(生息地)北アメリカ・カナダアラスカの森林地帯<\h3>" + "<br>"
    +"<h2>名前：ユウキ(2011年うまれ)<\h2>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n"
    +"<p>オオカミは、オスの中でもっとも強いオス(アルファオス)とメスの中でもっとも強いメス(アルファメス)とがパック(群れ)を形成して暮らしている。"+"<br>"
    +"群れの中では、社会的なきずなが発達しており、狩りや子育てなどいつも共同で行動している。" + "<br>"
    +"オオカミの遠吠え、群れの仲間との連絡、狩りの前触れ、縄張りの主張などの目的で行われ、それぞれ吠え方が異なる。"
    +"条件があえば、10km先まで届く。"+"<br>"
    +"※「オオカミの特徴」についても見てみてね！<\p>",


    //ホッキョクグマ
    "<h3>観覧時間は9:30～16:00だよ！<\h3>" + "\n" 
    +"<h3>食肉目(ネコ目)クマ科" +"<br>" +"(生息地)北極圏周辺の沿岸や流氷<\h3>" + "<br>"
    +"<h2>名前：ポロロ(2012年うまれ、メス)、"+"<br>"+"イワン(2000年うまれ、オス)<\h2>" +"<br>"
    +"<h3>～どんなどうぶつ？～<\h3>" + "\n"
    +"<p>世界最大の肉食動物であり、オスの体重は300kg、最大で800kgになる。体の色は白いが、夏は日光による酸化で黄色っぽくなる。" + "<br>"
    +"厚い脂肪と密生した下毛や長い上毛で、マイナス45℃になる厳しい夜冬の寒さをしのぐ。また、泳ぎが得意で時速6.5kmで65km泳いだ、との報告がある。" + "<br>"
    +"オスとメスは3月~6月の交尾期だけいっしょにいて、出産は11月~1月に1頭~4頭を出産する。冬ごもりする妊娠中のメス。"+"<br>"+"<br>"
    ...
    +"体重が重いコンドルの飛翔はスズメやハトのように羽ばたくのではなく、上昇気流をたくみに利用し、高度4500mまで上昇することができ、上空から鋭い視覚で動物の死体を見つける。" + "<br>"
    +"飛ぶ鳥の中で一番大きく、翼を広げると3mに達し、大きいもので体重が14kgになる。" + "<br>"
    +"オスは額に肉冠、あごに肉垂がある。メスの目は赤く、オスは灰かかった茶色である。猛禽類でオス・メスの形態が大きく違うのはアンデスコンドルだけである。"+"<br>" + "<br>" 
    +"※水・金・日曜日の13時～：食事風景が見られるよ！<\p>",
