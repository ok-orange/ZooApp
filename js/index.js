...
function HowToUse(){
  ...
  document.getElementById("text_ae").innerHTML
    = "<h3>※画面を開いている間に近づいた動物のみ、情報が見られます。"+"<br>"+"<br>"
    +"<h3>マップ</h3>"
      + "<p>・黄色いまる：動物の近くでタップすると、どうぶつ情報が見られるよ！</p>"+"<br>"
    + "<h3>メニューバー(画面下部)</h3>"
      + "<p>・現在地：タップするごとに、マップに現在地を表示・非表示できるよ！"+"<br>"
         + "・ベンチ・トイレ：タップするごとに、マップにトイレ・ベンチの場所を表示・非表示できるよ！</p>"+"<br>"
    + "<h3>終了するとき</h3>"
...
function ShowPosition(){
  if(posi_f == 0){
    ...
    marker = new google.maps.Marker({
      ...
      position: {lat: 34.01414, lng: 134.52195},
      map: map,
